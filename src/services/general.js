...
module.exports = {EliminarComment,EdithComment,userInformation,EdithMessageStatus,AllMessageUser,EdithMessage,AllComment,createUser,login,AllUser,createComment,AllMessage };
